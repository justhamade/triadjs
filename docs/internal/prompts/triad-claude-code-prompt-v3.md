...
- The `@triadjs/drizzle` package handles the generation (separate from `@triadjs/core`)
...
│   │       └── router.test.ts
│   │
│   ├── openapi/                    # @triadjs/openapi — full OpenAPI 3.1 document generator
│   │   ├── package.json
│   │   ├── tsconfig.json
│   │   ├── src/
│   │   │   ├── index.ts
...
│   │       └── generator.test.ts
│   │
│   ├── test-runner/                # @triadjs/test-runner — executes behaviors as tests
│   │   ├── package.json
│   │   ├── tsconfig.json
│   │   ├── src/
│   │   │   ├── index.ts
...
│   │       └── runner.test.ts
│   │
│   ├── gherkin/                    # @triadjs/gherkin — generates .feature files
│   │   ├── package.json
│   │   ├── tsconfig.json
│   │   ├── src/
│   │   │   ├── index.ts
...
│   │       └── generator.test.ts
│   │
│   ├── drizzle/                    # @triadjs/drizzle — generates Drizzle ORM schemas from Triad models
│   │   ├── package.json
│   │   ├── tsconfig.json
│   │   ├── src/
│   │   │   ├── index.ts
...
│   │       └── generator.test.ts
│   │
│   └── cli/                        # @triadjs/cli — CLI entry point
│       ├── package.json
│       ├── tsconfig.json
│       └── src/
│           ├── index.ts
...
### Phase 1: Schema DSL (`@triadjs/core/schema/`)
...
### Phase 2: Endpoint, Behavior, Router (`@triadjs/core/`)
...
### Phase 6: Test Runner (`@triadjs/test-runner/`)
1. Execute behaviors via supertest
2. Assertion implementations
3. Fixture lifecycle
4. Reporter

### Phase 7: CLI (`@triadjs/cli/`)
...
2. **NO HTTP framework dependency in `@triadjs/core`** — Core is framework-agnostic
